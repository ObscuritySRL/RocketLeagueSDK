...
import type { FIpAddr, FMap_Mirror, FName, FPointer, FScriptDelegate, FSparseArray_Mirror, FUniqueNetId } from '../structs/Core';
import type { FActiveLobbyInfo, FBasicLobbyInfo, FOnlineGameSearchResult } from '../structs/Engine';
...
import type { AvatarSize, ELanBeaconState } from '../enums/Engine';
...
import type { UDownload, UHttpRequestInterface, UHttpResponseInterface, UInfo, UNetConnection, UNetDriver, UOnlineGameSearch, UOnlineGameSettings, UOnlineSubsystem, UOnlineTitleFileCacheInterface, UOnlineTitleFileInterface, UTexture, UUIDataStore, UUIResourceDataProvider, UWorldInfo } from './Engine';
