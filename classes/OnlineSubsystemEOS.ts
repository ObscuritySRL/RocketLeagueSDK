...
import type { FMap_Mirror, FName, FPointer, FScriptDelegate, FSparseArray_Mirror, FVoiceAudioDevice } from '../structs/Core';
import type { FEpicDLCInfo, FNamedInterface, FNamedInterfaceDef, FNamedSession, FOnlineFriendMessage, FOnlineProfileSetting, FPS4DLCInfo, FSteamDLCInfo, FSwitchDLCInfo, FXboxOneDLCInfo } from '../structs/Engine';
import type { FAuthCodeRequest } from '../structs/IpDrv';
import type { FOnlineStatusMappingEOS } from '../structs/OnlineSubsystemEOS';
import type { OnlinePlatform } from '../enums/Core';
import type { ELanBeaconState, EOnlineEnumerationReadState, EOnlineServerConnectionStatus } from '../enums/Engine';
import type { UErrorList, UErrorType, UObject } from './Core';
import type { UIniLocPatcher, UOnlineAccountInterface, UOnlineAuthInterface, UOnlineCommunityContentInterface, UOnlineContentInterface, UOnlineFriendsInterface, UOnlineGameClipsInterface, UOnlineGameDVRInterface, UOnlineGameInterface, UOnlineGameSearch, UOnlineGameSettings, UOnlineLobbyInterface, UOnlineMarketplaceInterface, UOnlineNewsInterface, UOnlinePartyChatInterface, UOnlinePersistentAuthInterface, UOnlinePlayerInterface, UOnlinePlayerInterfaceEx, UOnlineProfileSettings, UOnlinePurchaseInterface, UOnlineSessionManager, UOnlineSocialInterface, UOnlineStatsInterface, UOnlineSystemInterface, UOnlineTitleFileCacheInterface, UOnlineTitleFileInterface, UOnlineVoiceInterface, USharedCloudFileInterface, UUserCloudFileInterface } from './Engine';
import type { UOnlineAuthInterfaceImpl, UOnlineFriendsInterfaceImpl, UOnlineGameInterfaceImpl, UOnlinePersistentAuthInterfaceImpl, UOnlinePurchaseInterfaceImpl, UOnlineSubsystemCommonImpl } from './IpDrv';
