...
import type { FColor, FName, FScriptDelegate, FUniqueNetId, FVoiceRoomMemberStatus } from '../structs/Core';
import type { FAchievementDetails, FEmsFile, FFriendHistoryKey, FFriendsQuery, FGameClipsMaskArea, FLocalizedStringSetting, FOnlineFriend, FOnlineFriendMessage, FOnlinePlayerScore, FSettingsProperty, FSpeechRecognizedWord, FWordFilterResult } from '../structs/Engine';
import type { EInputAPI, EVoiceResultCode, OnlinePlatform } from '../enums/Core';
import type { ECommunicationMethod, EFeaturePrivilege, EFeaturePrivilegeLevel, EGameClipsAvailability, EGameClipsClipStatus, EGameClipsConnection, EGameClipsConnectionStatus, EGameClipsMaskStatus, EGameClipsRecording, ELoginStatus, ENATType, ENetworkNotificationPosition, EOnlineAccountCreateStatus, EOnlineEnumerationReadState, EOnlineServerConnectionStatus, EPS4DisplayMode, EPS4ErrorDialog, EPinGrantResult } from '../enums/Engine';
...
export type OnlinePlayerInterfaceEOS_WordFilterSanitizeString_Params = {
  ...
  PlayerID: FUniqueNetId;  // 0x0028 (0x0048) [FUniqueNetId] [CPF_Parm]
