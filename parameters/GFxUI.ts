...
import type { FMatrix, FName, FScriptDelegate } from '../structs/Core';
...
export type GFxClikWidget_AddEventListener_Params = {
  ...
  useCapture: boolean;  // 0x0020 (0x0004) [bool : 0x1] [CPF_Parm]
  listenerPriority: number;  // 0x0024 (0x0004) [int32] [CPF_Parm]
  useWeakReference: boolean;  // 0x0028 (0x0004) [bool : 0x1] [CPF_Parm]
...
export type GFxClikWidget_AS3AddEventListener_Params = {
  ...
  useCapture: boolean;  // 0x0018 (0x0004) [bool : 0x1] [CPF_Parm]
  listenerPriority: number;  // 0x001c (0x0004) [int32] [CPF_Parm]
  useWeakReference: boolean;  // 0x0020 (0x0004) [bool : 0x1] [CPF_Parm]
};
...
export type GFxMoviePlayer_Close_Params = {
  Unload: boolean;  // 0x0000 (0x0004) [bool : 0x1] [CPF_Parm]
};
...
export type GFxMoviePlayer_CreateObject_Params = {
  ...
  Type: bigint;  // 0x0010 (0x0008) [UClass*] [CPF_Parm]
  args: FASValue[];  // 0x0018 (0x0010) [TArray<FASValue>] [CPF_Parm]
...
export type GFxMoviePlayer_Init_Params = {
  LocPlay: ULocalPlayer;  // 0x0000 (0x0008) [ULocalPlayer*] [CPF_Parm]
};
...
export type GFxMoviePlayer_RequestGarbageCollection_Params = {
  Mode: GFxCollectionMode;  // 0x0000 (0x0001) [GFxCollectionMode] [CPF_Parm]
...
export type GFxMoviePlayer_SetPause_Params = {
  bPausePlayback: boolean;  // 0x0000 (0x0004) [bool : 0x1] [CPF_Parm]
};
...
export type GFxObject_AttachMovie_Params = {
  ...
  Depth: number;  // 0x0020 (0x0004) [int32] [CPF_Parm]
  Type: bigint;  // 0x0028 (0x0008) [UClass*] [CPF_Parm]
...
export type GFxObject_CreateEmptyMovieClip_Params = {
  ...
  Depth: number;  // 0x0010 (0x0004) [int32] [CPF_Parm]
  Type: bigint;  // 0x0018 (0x0008) [UClass*] [CPF_Parm]
...
export type GFxObject_GetElementObject_Params = {
  Index: number;  // 0x0000 (0x0004) [int32] [CPF_Parm]
  Type: bigint;  // 0x0008 (0x0008) [UClass*] [CPF_Parm]
  ReturnValue: UGFxObject;  // 0x0010 (0x0008) [UGFxObject*] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type GFxObject_SetString_Params = {
  Member: string;  // 0x0000 (0x0010) [FString] [CPF_Parm]
  S: string;  // 0x0010 (0x0010) [FString] [CPF_Parm]
  InContext: UTranslationContext;  // 0x0020 (0x0008) [UTranslationContext*] [CPF_Parm]
};
...
export type GFxObject_SetText_Params = {
  ...
  InContext: UTranslationContext;  // 0x0010 (0x0008) [UTranslationContext*] [CPF_Parm]
};
