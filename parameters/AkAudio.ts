...
import type { FLinearColor, FName, FRotator, FScriptDelegate, FVector } from '../structs/Core';
...
import type { UAkEnvironments, UAkMusicAnalysis, UAkRevPhysicsSimulation, UAkSoundBanksInfo, UAkSoundCue, USeqEvent_AkMusicCue } from '../classes/AkAudio';
...
export type AkDevice_GetSoundSource_Params = {
  ...
  Translation: FVector;  // 0x0008 (0x000c) [FVector] [CPF_Parm]
  Rotation: FRotator;  // 0x0014 (0x000c) [FRotator] [CPF_Parm]
...
export type AkDevice_PlaySound_Params = {
  ...
  Translation: FVector;  // 0x0010 (0x000c) [FVector] [CPF_Parm]
  Rotation: FRotator;  // 0x001c (0x000c) [FRotator] [CPF_Parm]
