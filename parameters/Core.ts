...
import type { FColor, FGuid, FInterpCurveFloat, FInterpCurveVector, FInterpCurveVector2D, FLinearColor, FMatrix, FName, FQuat, FRotator, FRotatorDegrees, FRotatorRadians, FScriptDelegate, FVector, FVector2D } from '../structs/Core';
import type { EAxis, EDebugBreakType } from '../enums/Core';
import type { UAsyncTask, UDebugDrawer, UError, UErrorType, UInterface, UObject, USubscription, U__AsyncTask__All_0x1 } from '../classes/Core';
...
export type DebugDrawer_PrintText_Params = {
  ...
  InColor: FColor;  // 0x0010 (0x0004) [FColor] [CPF_Parm]
};
...
export type DistributionVector_GetVectorValue_Params = {
  F: number;  // 0x0000 (0x0004) [float] [CPF_Parm]
  LastExtreme: number;  // 0x0004 (0x0004) [int32] [CPF_Parm]
...
export type ErrorType_CreateError_Params = {
  InErrorMessage: string;  // 0x0000 (0x0010) [FString] [CPF_Parm]
  InErrorCode: number;  // 0x0010 (0x0004) [int32] [CPF_Parm]
...
export type FileSystem_LoadFileToBytes_Params = {
  ...
  StartOffset: number;  // 0x0020 (0x0004) [int32] [CPF_Parm]
  Length: number;  // 0x0024 (0x0004) [int32] [CPF_Parm]
...
export type Object_CalculateGravityPosition_Params = {
  ...
  GravityDirection: FVector;  // 0x0020 (0x000c) [FVector] [CPF_Parm]
...
export type Object_ClassIsChildOf_Params = {
  TestClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
  ParentClass: bigint;  // 0x0008 (0x0008) [UClass*] [CPF_Parm]
  ReturnValue: boolean;  // 0x0010 (0x0004) [bool : 0x1] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_DebugBreak_Params = {
  UserFlags: number;  // 0x0000 (0x0004) [int32] [CPF_Parm]
  DebuggerType: EDebugBreakType;  // 0x0004 (0x0001) [EDebugBreakType] [CPF_Parm]
};
...
export type Object_DuplicateObject_Params = {
  ...
  ObjOuter: UObject;  // 0x0008 (0x0008) [UObject*] [CPF_Parm]
  DestClass: bigint;  // 0x0010 (0x0008) [UClass*] [CPF_Parm]
...
export type Object_DynamicLoadObject_Params = {
  ...
  ObjectClass: bigint;  // 0x0010 (0x0008) [UClass*] [CPF_Parm]
  MayFail: boolean;  // 0x0018 (0x0004) [bool : 0x1] [CPF_Parm]
...
export type Object_EnumFromString_Params = {
  ...
  ValueName: FName;  // 0x0008 (0x0008) [FName] [CPF_Parm]
  ReturnValue: number;  // 0x0010 (0x0004) [int32] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_EqualEqual_InterfaceInterface_Params = {
  A: UInterface;  // 0x0000 (0x0010) [TScriptInterface<UInterface>] [CPF_Parm]
  B: UInterface;  // 0x0010 (0x0010) [TScriptInterface<UInterface>] [CPF_Parm]
  ReturnValue: boolean;  // 0x0020 (0x0004) [bool : 0x1] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_FindProperty_Params = {
  PropertyClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
...
export type Object_FlattenRotatorOnAxis_Params = {
  ...
  RotToFlattenTo: FRotator;  // 0x0018 (0x000c) [FRotator] [CPF_Parm]
...
export type Object_GetEnum_Params = {
  E: UObject;  // 0x0000 (0x0008) [UObject*] [CPF_Parm]
  I: number;  // 0x0008 (0x0004) [int32] [CPF_Parm]
...
export type Object_GetPerObjectConfigObjects_Params = {
  SearchClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
  OutObject: UObject;  // 0x0008 (0x0008) [UObject*] [CPF_Parm | CPF_OutParm]
  ObjectOuter: UObject;  // 0x0010 (0x0008) [UObject*] [CPF_Parm]
  MaxResults: number;  // 0x0018 (0x0004) [int32] [CPF_Parm]
};
...
export type Object_GetPerObjectConfigSections_Params = {
  ...
  ObjectOuter: UObject;  // 0x0018 (0x0008) [UObject*] [CPF_Parm]
  MaxResults: number;  // 0x0020 (0x0004) [int32] [CPF_Parm]
...
export type Object_GetSingleton_Params = {
  ObjClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
...
export type Object_GetTextArchetype_Params = {
  ArchetypeClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
...
export type Object_GotoState_Params = {
  ...
  Label: FName;  // 0x0008 (0x0008) [FName] [CPF_Parm]
  bForceEvents: boolean;  // 0x0010 (0x0004) [bool : 0x1] [CPF_Parm]
  bKeepStack: boolean;  // 0x0014 (0x0004) [bool : 0x1] [CPF_Parm]
};
...
export type Object_InCylinder_Params = {
  ...
  bIgnoreZ: boolean;  // 0x0028 (0x0004) [bool : 0x1] [CPF_Parm]
...
export type Object_InStr_Params = {
  S: string;  // 0x0000 (0x0010) [FString] [CPF_Parm]
  T: string;  // 0x0010 (0x0010) [FString] [CPF_Parm]
  bSearchFromRight: boolean;  // 0x0020 (0x0004) [bool : 0x1] [CPF_Parm]
  bIgnoreCase: boolean;  // 0x0024 (0x0004) [bool : 0x1] [CPF_Parm]
  StartPos: number;  // 0x0028 (0x0004) [int32] [CPF_Parm]
...
export type Object_IsInState_Params = {
  TestState: FName;  // 0x0000 (0x0008) [FName] [CPF_Parm]
  bTestStateStack: boolean;  // 0x0008 (0x0004) [bool : 0x1] [CPF_Parm]
  ReturnValue: boolean;  // 0x000c (0x0004) [bool : 0x1] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_JoinArray_Params = {
  ...
  bIgnoreBlanks: boolean;  // 0x0030 (0x0004) [bool : 0x1] [CPF_Parm]
};
...
export type Object_JoinArrayInt_Params = {
  ...
  delim: string;  // 0x0010 (0x0010) [FString] [CPF_Parm]
  bIgnoreBlanks: boolean;  // 0x0020 (0x0004) [bool : 0x1] [CPF_Parm]
...
export type Object_LinePlaneIntersection_Params = {
  ...
  Out_T: number;  // 0x003c (0x0004) [float] [CPF_Parm | CPF_OutParm]
  bCheckLineSegment: boolean;  // 0x0040 (0x0004) [bool : 0x1] [CPF_Parm]
...
export type Object_Localize_Params = {
  ...
  PackageName: string;  // 0x0020 (0x0010) [FString] [CPF_Parm]
  bOptional: boolean;  // 0x0030 (0x0004) [bool : 0x1] [CPF_Parm]
...
export type Object_LogInternal_Params = {
  S: string;  // 0x0000 (0x0010) [FString] [CPF_Parm]
  Tag: FName;  // 0x0010 (0x0008) [FName] [CPF_Parm]
  bFileOnly: boolean;  // 0x0018 (0x0004) [bool : 0x1] [CPF_Parm]
};
...
export type Object_MakeColor_Params = {
  ...
  A: number;  // 0x0003 (0x0001) [uint8] [CPF_Parm]
  ReturnValue: FColor;  // 0x0004 (0x0004) [FColor] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
...
export type Object_MakeLinearColor_Params = {
  ...
  B: number;  // 0x0008 (0x0004) [float] [CPF_Parm]
  A: number;  // 0x000c (0x0004) [float] [CPF_Parm]
  ReturnValue: FLinearColor;  // 0x0010 (0x0010) [FLinearColor] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_Mid_Params = {
  S: string;  // 0x0000 (0x0010) [FString] [CPF_Parm]
  I: number;  // 0x0010 (0x0004) [int32] [CPF_Parm]
  J: number;  // 0x0014 (0x0004) [int32] [CPF_Parm]
  ReturnValue: string;  // 0x0018 (0x0010) [FString] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_NewInstance_Params = {
  ObjOuter: UObject;  // 0x0000 (0x0008) [UObject*] [CPF_Parm]
  ObjName: FName;  // 0x0008 (0x0008) [FName] [CPF_Parm]
  ReturnValue: UObject;  // 0x0010 (0x0008) [UObject*] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_PadRight_Params = {
  S: string;  // 0x0000 (0x0010) [FString] [CPF_Parm]
  WidthChars: number;  // 0x0010 (0x0004) [int32] [CPF_Parm]
  ReturnValue: string;  // 0x0018 (0x0010) [FString] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
...
export type Object_PointDistToLine_Params = {
  ...
  OutClosestPoint: FVector;  // 0x0024 (0x000c) [FVector] [CPF_Parm | CPF_OutParm]
...
export type Object_PointDistToPlane_Params = {
  ...
  Origin: FVector;  // 0x0018 (0x000c) [FVector] [CPF_Parm]
  out_ClosestPoint: FVector;  // 0x0024 (0x000c) [FVector] [CPF_Parm | CPF_OutParm]
  ReturnValue: number;  // 0x0030 (0x0004) [float] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
...
export type Object_PopState_Params = {
  bPopAll: boolean;  // 0x0000 (0x0004) [bool : 0x1] [CPF_Parm]
};
...
export type Object_ProfNodeStop_Params = {
  AssumedTimerIndex: number;  // 0x0000 (0x0004) [int32] [CPF_Parm]
};
...
export type Object_ProjectOnToPlane_Params = {
  ...
  InNormal: FVector;  // 0x000c (0x000c) [FVector] [CPF_Parm]
  OverBounce: number;  // 0x0018 (0x0004) [float] [CPF_Parm]
  ReturnValue: FVector;  // 0x001c (0x000c) [FVector] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
 ...
 */
export type Object_QSubtract_Params = {
  A: bigint;  // 0x0000 (0x0008) [uint64] [CPF_Parm]
  B: bigint;  // 0x0008 (0x0008) [uint64] [CPF_Parm]
  ReturnValue: bigint;  // 0x0010 (0x0008) [uint64] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_QuatSlerp_Params = {
  ...
  B: FQuat;  // 0x0010 (0x0010) [FQuat] [CPF_Parm]
  Alpha: number;  // 0x0020 (0x0004) [float] [CPF_Parm]
  bShortestPath: boolean;  // 0x0024 (0x0004) [bool : 0x1] [CPF_Parm]
...
export type Object_Repl_Params = {
  ...
  Match: string;  // 0x0010 (0x0010) [FString] [CPF_Parm]
  With: string;  // 0x0020 (0x0010) [FString] [CPF_Parm]
  bCaseSensitive: boolean;  // 0x0030 (0x0004) [bool : 0x1] [CPF_Parm]
  ReturnValue: string;  // 0x0038 (0x0010) [FString] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_RInterpTo_Params = {
  ...
  bConstantInterpSpeed: boolean;  // 0x0020 (0x0004) [bool : 0x1] [CPF_Parm]
  ReturnValue: FRotator;  // 0x0024 (0x000c) [FRotator] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_RLerp_Params = {
  ...
  bShortestPath: boolean;  // 0x001c (0x0004) [bool : 0x1] [CPF_Parm]
...
export type Object_RotRand_Params = {
  bRoll: boolean;  // 0x0000 (0x0004) [bool : 0x1] [CPF_Parm]
  ReturnValue: FRotator;  // 0x0004 (0x000c) [FRotator] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type Object_Split_Params = {
  Text: string;  // 0x0000 (0x0010) [FString] [CPF_Parm]
  SplitStr: string;  // 0x0010 (0x0010) [FString] [CPF_Parm]
  bOmitSplitStr: boolean;  // 0x0020 (0x0004) [bool : 0x1] [CPF_Parm]
  ReturnValue: string;  // 0x0028 (0x0010) [FString] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
...
export type Object_SplitString_Params = {
  ...
  Delimiter: string;  // 0x0010 (0x0010) [FString] [CPF_Parm]
  bCullEmpty: boolean;  // 0x0020 (0x0004) [bool : 0x1] [CPF_Parm]
...
export type Object_TransformVectorByRotation_Params = {
  ...
  bInverse: boolean;  // 0x0018 (0x0004) [bool : 0x1] [CPF_Parm]
  ReturnValue: FVector;  // 0x001c (0x000c) [FVector] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type ObjectProvider_AddProxy_Params = {
  InProxy: unknown;  // 0x0000 (0x0008) [unknown] [CPF_Parm]
};
...
export type ObjectProvider_AllObjects_Params = {
  BaseClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
  Obj: UObject;  // 0x0008 (0x0008) [UObject*] [CPF_Parm | CPF_OutParm]
  InterfaceClass: bigint;  // 0x0010 (0x0008) [UClass*] [CPF_Parm]
};
...
export type ObjectProvider_RemoveAllObjects_Params = {
  ObjectClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
};
...
export type ObjectProvider_SetParent_Params = {
  InParent: unknown;  // 0x0000 (0x0008) [unknown] [CPF_Parm]
};
...
export type ObjectProvider_Subscribe_Params = {
  BaseClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
  OnAdd: FScriptDelegate;  // 0x0008 (0x0018) [FScriptDelegate] [CPF_Parm]
  OnRemove: FScriptDelegate;  // 0x0020 (0x0018) [FScriptDelegate] [CPF_Parm]
};
...
export type ObjectUtil_AllCDOs_Params = {
  ...
  bIncludeAbstract: boolean;  // 0x0010 (0x0004) [bool : 0x1] [CPF_Parm]
};
...
export type ObjectUtil_FindClass_Params = {
  ClassName: FName;  // 0x0000 (0x0008) [FName] [CPF_Parm]
  ReturnValue: bigint;  // 0x0008 (0x0008) [UClass*] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
...
export type ObjectUtil_GetCDO_Params = {
  InClass: bigint;  // 0x0000 (0x0008) [UClass*] [CPF_Parm]
  ReturnValue: UObject;  // 0x0008 (0x0008) [UObject*] [CPF_Parm | CPF_OutParm | CPF_ReturnParm]
};
