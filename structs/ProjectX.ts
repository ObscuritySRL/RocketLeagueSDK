...
import type { FColor, FEncryptedKeyIndex, FGuid, FInterpCurveFloat, FInterpCurveLinearColor, FInterpCurveVector, FLinearColor, FMap_Mirror, FMatrix, FName, FPointer, FQuat, FRawDistributionFloat, FRotator, FScriptDelegate, FUniqueNetId, FVector } from './Core';
...
import type { DLCOwnershipState, EAttachActorLocationUnlockFlags, EAxisSign, EButtonPressType, EChatChannel, EChatPermissionLevel, EChatReportingLevel, EClubBadge, EClubRole, EExploitType, EFXComponentState, EFXComponentTarget, EFXOverrideAttachBehavior, EJoinMatchType, EObjectEncoding, EOnlinePlayerPermission, ERemappable, EReservationStatus, ETradePermissionLevel, EWordFilterUsage, FakeDataEnum } from '../enums/ProjectX';
import type { UAkSoundCue } from '../classes/AkAudio';
import type { UAsyncTask, UError, UErrorType, UObject, UProperty } from '../classes/Core';
import type { UActor, UNetworkEncryptionKey, UParticleSystem, UPhysicalMaterial, UPlayerController, UPlayerReplicationInfo, UPostProcessChain, UPostProcessVolume, UTexture2DDynamic } from '../classes/Engine';
import type { UAddReservationMessage_X, UCachedWebData_X, UCameraState_X, UEOSMetricEvent_X, UFXActorEvent_X, UFXAttachmentTraitBase_X, UGFxDataRow_X, UIReservationConnection_X, UPsyNetClientService_X, UPsyNetMessage_X, URPC_X, URuntimeParameterBase_X, UTAsyncResult__PsyNetMessage_X, UWebRequest_X } from '../classes/ProjectX';
...
export type FBeaconMessageHandler = {
  MessageClass: bigint;  // 0x0000 (0x0008) [UClass*]
...
export type FMigrationReservationData = {
  ...
  Status: EReservationStatus;  // 0x00a8 (0x0001) [EReservationStatus]
  bDisableCrossPlay: boolean;  // 0x00ac (0x0004) [bool : 0x1]
  Team: number;  // 0x00b0 (0x0001) [uint8]
  Skill: FSkillRating;  // 0x00b4 (0x0008) [FSkillRating]
  MapLikes: FName[];  // 0x00c0 (0x0010) [TArray<FName>]
  MapDislikes: FName[];  // 0x00d0 (0x0010) [TArray<FName>]
  SecurityKey: UNetworkEncryptionKey;  // 0x00e0 (0x0008) [UNetworkEncryptionKey*]
};
...
export type FOnlinePlayerStorageSyncResult = {
  DataClass: bigint;  // 0x0000 (0x0008) [UClass*]
...
export type FPendingReservation = {
  Connection: UIReservationConnection_X;  // 0x0000 (0x0010) [TScriptInterface<UIReservationConnection_X>]
...
export type FPendingStorage = {
  ...
  DataClass: bigint;  // 0x0008 (0x0008) [UClass*]
...
export type FPrimitiveComponentProfile = {
  ...
  Components: unknown[];  // 0x0010 (0x0010) [TArray<unknown>]
...
export type FReservationData = {
  ...
  Connection: UIReservationConnection_X;  // 0x00d0 (0x0010) [TScriptInterface<UIReservationConnection_X>]
...
export type FServiceSubscription = {
  Class: bigint;  // 0x0000 (0x0008) [UClass*]
  Callback: FScriptDelegate;  // 0x0008 (0x0018) [FScriptDelegate]
};
